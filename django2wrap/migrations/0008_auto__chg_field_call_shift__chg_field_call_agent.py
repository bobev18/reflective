...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Call.shift'
        db.alter_column('django2wrap_call', 'shift_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django2wrap.Shift'], null=True))

        # Changing field 'Call.agent'
        db.alter_column('django2wrap_call', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django2wrap.Agent'], null=True))

    def backwards(self, orm):

        # Changing field 'Call.shift'
        db.alter_column('django2wrap_call', 'shift_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['django2wrap.Shift']))

        # Changing field 'Call.agent'
        db.alter_column('django2wrap_call', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['django2wrap.Agent']))
