...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Call.contact'
        db.add_column('django2wrap_call', 'contact',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Call.contact'
        db.delete_column('django2wrap_call', 'contact')
    ...
    models = {
        ...
        'django2wrap.call': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '128'}),
