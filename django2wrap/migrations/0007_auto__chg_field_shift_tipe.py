...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shift.tipe'
        db.alter_column('django2wrap_shift', 'tipe', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Shift.tipe'
        db.alter_column('django2wrap_shift', 'tipe', self.gf('django.db.models.fields.CharField')(max_length=1))
