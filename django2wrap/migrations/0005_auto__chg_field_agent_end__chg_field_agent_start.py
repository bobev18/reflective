...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agent.end'
        db.alter_column('django2wrap_agent', 'end', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Agent.start'
        db.alter_column('django2wrap_agent', 'start', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Agent.end'
        db.alter_column('django2wrap_agent', 'end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Agent.start'
        db.alter_column('django2wrap_agent', 'start', self.gf('django.db.models.fields.DateTimeField')())
