...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Call.contact'
        db.alter_column('django2wrap_call', 'contact', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Call.contact'
        db.alter_column('django2wrap_call', 'contact', self.gf('django.db.models.fields.CharField')(default=None, max_length=128))
    ...
    models = {
        ...
        'django2wrap.call': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '128', 'null': 'True'}),
